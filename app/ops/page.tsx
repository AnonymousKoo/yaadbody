...
export default function OpsPage() {
  ...
  return <><SiteHeader /><main className="mx-auto max-w-[var(--page-width)] px-5 py-10 lg:px-8">
    <div className="flex flex-wrap items-end justify-between gap-5"><div><p className="eyebrow">Internal prototype</p><h1 className="mt-3 text-4xl font-black tracking-[-.06em] sm:text-5xl">Kitchen control board</h1><p className="mt-3 text-[var(--ink-muted)]">Demo demand, waste, and production signals. No production data is connected.</p></div><span className="rounded-full bg-[#fff0e8] px-4 py-2 text-xs font-black uppercase tracking-[.12em] text-[var(--brand-deep)]">Local fixture data</span></div>
