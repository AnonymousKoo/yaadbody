...
import { PricingDecisionPanel } from "@/components/pricing-decision-panel";
...
export function MealCostingWorkbench() {
  ...
  return <div className="grid gap-8 xl:grid-cols-[1fr_380px]">
    <section className="space-y-7">
      ...
      <PricingDecisionPanel costCents={result.trueMealCostCents ?? result.estimatedFullyLoadedCostCents} costStatus={result.status} />
    </section>
